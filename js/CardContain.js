...
cardData.forEach((card) => {
  ...
  cardElement.className =
    "group bg-white relative font-nunito flex justify-between pr-[10px] py-[15px] rounded-[5px] border w-full overflow-hidden transition-transform transform hover:scale-105";
  ...
  cardElement.innerHTML = `
    <div class="gap-[20px] w-full pb-[10px] md:h-[150px] ">
      ...
      <div class="flex border-t pt-[5px] gap-[5px] items-center justify-center">
      <img src= ${card.imgs} class="w-[20px] h-[20px] object-contain" alt="">
      <p class=" text-[12px] px-[10px] md:text-[14px] leading-[38.19px] font-semibold font-nunito text-center">
      ${card.message}</p>
      </div>
    </div>
    <!-- Overlay -->
